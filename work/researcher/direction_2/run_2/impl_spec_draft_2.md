    ...
    for stock_id in stock_ids:
        ...
        for j in range(k_bins):
            ...
            weights = compute_vwap_weights(
                model_params, stock_id, e_last, j, use_setar
            )
            ...
            e_last = x_actual - c_forecast[idx, j]
...
k=26 (15-min bins), L=20 days, over 2648 forecast days.
