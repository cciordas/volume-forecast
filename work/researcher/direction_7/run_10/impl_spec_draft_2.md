...
Repeat until convergence or j >= max_iterations:
  ...
  # Check convergence using log-likelihood from the E-step:
  If j >= 2:
...
If it decreases, there is a bug in the E-step or M-step. This is guaranteed by Jensen's
inequality in the EM derivation. Reference: Researcher inference from EM theory.
